...
public class DemoTester {
    ...
    public static void main(String[] args) {
        ...
        List<Message> messagesForTopic1 = new ArrayList<>(102400);
        List<Message> messagesForTopic2 = new ArrayList<>(102400);
        List<Message> messagesForQueue1 = new ArrayList<>(102400);
        List<Message> messagesForQueue2 = new ArrayList<>(102400);
        ...
        for (int i = 0; i < 102400; i++) {
            producer.send(messagesForTopic1.get(i%102400));
            producer.send(messagesForTopic2.get(i%102400));
            producer.send(messagesForQueue1.get(i%102400));
            producer.send(messagesForQueue2.get(i%102400));
        }
        producer.flush();
